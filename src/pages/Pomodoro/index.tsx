...
import { HtmlTags } from "../../components/Html";
  ...
  return (
    <Container>
      <HtmlTags>
        ...
        <h2>
          Mas no <strong>Chronos Pomodora</strong> tem um diferencial 🚀
        </h2>
        ...
        <h2>Por que usar o Chronos Pomodora?</h2>
        <ul>
